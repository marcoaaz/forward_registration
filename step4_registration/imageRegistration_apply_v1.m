...
main_folder = 'D:\Justin Freeman collab\Marco Zircon_16bit\prototype2_work\qupath_project\output_test2\project_22-Apr-25\';

files2 = {
    'D:\Justin Freeman collab\Marco Zircon_16bit\prototype2_work\qupath_project\output_test2\project_22-Apr-25\aspectRatio_1\option1_spot_table.xlsx';    
    };
...
file3 = "D:\Justin Freeman collab\Marco Zircon_16bit\prototype2_work\qupath_project\output_test2\project_1-Feb\registration_intermediateFiles\cp_reg2.csv";
[workingDir, ~, ~] = fileparts(file3);
...
files4 = fullfile(destDir3, basenames1); %landmarks
n_files = length(files1); %must correspond to files2

registration2_cp = readtable(file3);

%medicine
registration1_cp_imputed = readtable(files4{1});
z_value_reg1 = registration1_cp_imputed{1, 5};
...
movingLandmarks = registration2_cp{:, {'Var3', 'Var4', 'Var5'}};
fixedLandmarks = registration2_cp{:, {'Var6', 'Var7', 'Var8'}};
...
z_value_reg2 = z_value_reg1;%medicine
...
selected_cp = 1:length(movingLandmarks);
