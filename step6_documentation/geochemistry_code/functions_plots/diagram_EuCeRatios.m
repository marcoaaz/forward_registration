function diagram_EuCeRatios(table_calculations, n_bins, pctOut)
...
%% Eu and Ce anomalies ratio fertility plot
...
title('Fertility plot after Pizarro et al. (2020, Fig. 7 & Fig 10 top right)')
